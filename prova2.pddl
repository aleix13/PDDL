...
(:objects
  ...
  (:init
    ...
    (dificultat_actual ex4 d1)
    (dificultat_actual ex5 d1)
    (dificultat_actual ex6 d1)
    (dificultat_actual ex7 d1)
    )
    (:goal (and (dia_actual dia15)
    (dificultat_actual ex1 d4)
    (dificultat_actual ex2 d4)
    (dificultat_actual ex3 d5)
    (dificultat_actual ex4 d6)
    (dificultat_actual ex5 d4)
    (dificultat_actual ex6 d3)
